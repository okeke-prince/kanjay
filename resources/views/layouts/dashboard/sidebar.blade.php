<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="sidenav-header mb-4">
    ...
    <a class="navbar-brand m-auto" href="/dashboard">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/dashboard/locations">
          ...
          <span class="nav-link-text ms-1">Tour Locations</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/dashboard/images">
          ...
          <span class="nav-link-text ms-1">Pages Image</span>
        </a>
      </li>
  ...
  <div class="sidenav-footer mx-3 ">
    ...
    <form method="POST" action="{{ route('logout') }}">
      @csrf
      <a class="btn bg-gradient-primary mt-3 w-100" href="#" onclick="event.preventDefault(); this.closest('form').submit();">Logout</a>
    </form>
